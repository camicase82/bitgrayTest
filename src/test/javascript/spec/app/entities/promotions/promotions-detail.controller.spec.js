...
describe('Controller Tests', function() {
    ...
    describe('Promotions Management Detail Controller', function() {
        var $scope, $rootScope;
        var MockEntity, MockPreviousState, MockPromotions, MockRecharges;
        ...
        beforeEach(inject(function($injector) {
            ...
            createController = function() {
                $injector.get('$controller')("PromotionsDetailController", locals);
            };
        }));
        ...
        describe('Root Scope Listening', function() {
            it('Unregisters root scope listener upon scope destruction', function() {
                var eventType = 'kiwiCellApp:promotionsUpdate';
